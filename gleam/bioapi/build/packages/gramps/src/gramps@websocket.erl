...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 30).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 201).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 209).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 239).
-spec make_frame(
    integer(),
    integer(),
    bitstring(),
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 165).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 181).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 266).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 276).
-spec to_text_frame(
    binary(),
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 294).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 324).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 340).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 386).
-spec inflate(
    boolean(),
    gleam@option:option(gramps@websocket@compression:context()),
    bitstring()
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 63).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 311).
-spec get_messages(
    bitstring(),
    list(parsed_frame()),
    gleam@option:option(gramps@websocket@compression:context())
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 402).
...
-file("/home/alex/gleams/gramps/src/gramps/websocket.gleam", 373).
