...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http/handler.gleam", 27).
-spec initial_state() -> state().
initial_state() ->
    {state, none}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http/handler.gleam", 67).
-spec log_and_error(
    gleam@erlang:crash(),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http/handler.gleam", 101).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http/handler.gleam", 159).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http/handler.gleam", 219).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http/handler.gleam", 246).
-spec int_to_hex(integer()) -> binary().
int_to_hex(Int) ->
    erlang:integer_to_list(Int, 16).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http/handler.gleam", 121).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http/handler.gleam", 31).
-spec call(
    gleam@http@request:request(mist@internal@http:connection()),
