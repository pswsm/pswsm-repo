...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/clock.gleam", 56).
-spec stop(any()) -> gleam@erlang@atom:atom_().
stop(_) ->
    erlang:binary_to_atom(<<"ok"/utf8>>).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/clock.gleam", 89).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/clock.gleam", 102).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/clock.gleam", 73).
-spec date() -> binary().
date() ->
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/clock.gleam", 29).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/clock.gleam", 60).
