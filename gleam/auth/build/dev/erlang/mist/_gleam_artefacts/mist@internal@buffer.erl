...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/buffer.gleam", 8).
-spec empty() -> buffer().
empty() ->
    {buffer, 0, <<>>}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/buffer.gleam", 12).
-spec new(bitstring()) -> buffer().
new(Data) ->
    {buffer, 0, Data}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/buffer.gleam", 16).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/buffer.gleam", 22).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/buffer.gleam", 30).
-spec with_capacity(buffer(), integer()) -> buffer().
with_capacity(Buffer, Size) ->
    erlang:setelement(2, Buffer, Size).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/buffer.gleam", 34).
