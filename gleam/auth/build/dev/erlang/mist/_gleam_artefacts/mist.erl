...
-opaque builder(HEZ, HFA) :: {builder,
        integer(),
        fun((gleam@http@request:request(HEZ)) -> gleam@http@response:response(HFA)),
...
-type websocket_message(HFB) :: {text, binary()} |
    {binary, bitstring()} |
    closed |
    shutdown |
    {custom, HFB}.
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 60).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 67).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 56).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 79).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 115).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 129).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 159).
-spec read_body(
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 188).
-spec do_stream(
    gleam@http@request:request(mist@internal@http:connection()),
    mist@internal@buffer:buffer()
) -> fun((integer()) -> {ok, chunk()} | {error, read_error()}).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 253).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 233).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 305).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 356).
-spec new(
    fun((gleam@http@request:request(HFY)) -> gleam@http@response:response(HGA))
) -> builder(HFY, HGA).
new(Handler) ->
    {builder,
        4000,
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 380).
-spec port(builder(HGE, HGF), integer()) -> builder(HGE, HGF).
port(Builder, Port) ->
    erlang:setelement(2, Builder, Port).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 387).
-spec read_request_body(
    builder(bitstring(), HGK),
    integer(),
    gleam@http@response:response(HGK)
) -> builder(mist@internal@http:connection(), HGK).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 409).
-spec after_start(
    builder(HGQ, HGR),
    fun((integer(), gleam@http:scheme(), ip_address()) -> nil)
) -> builder(HGQ, HGR).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 420).
-spec bind(builder(HGW, HGX), binary()) -> builder(HGW, HGX).
bind(Builder, Interface) ->
    erlang:setelement(5, Builder, Interface).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 429).
-spec with_ipv6(builder(HHC, HHD)) -> builder(HHC, HHD).
with_ipv6(Builder) ->
    erlang:setelement(6, Builder, true).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 433).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 459).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 463).
-spec get_port(server()) -> integer().
get_port(Server) ->
    erlang:element(3, Server).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 478).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 468).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 545).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 533).
-spec start_https(
    builder(mist@internal@http:connection(), response_data()),
    binary(),
    binary()
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 599).
-spec internal_to_public_ws_message(
    mist@internal@websocket:handler_message(HID)
) -> {ok, websocket_message(HID)} | {error, nil}.
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 624).
-spec websocket(
    gleam@http@request:request(mist@internal@http:connection()),
    fun((HIJ, mist@internal@websocket:websocket_connection(), websocket_message(HIK)) -> gleam@otp@actor:next(HIK, HIJ)),
    fun((mist@internal@websocket:websocket_connection()) -> {HIJ,
        gleam@option:option(gleam@erlang@process:selector(HIK))}),
    fun((HIJ) -> nil)
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 677).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 701).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 739).
-spec event(gleam@string_tree:string_tree()) -> sse_event().
event(Data) ->
    {sse_event, none, none, Data}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 744).
-spec event_id(sse_event(), binary()) -> sse_event().
event_id(Event, Id) ->
    erlang:setelement(2, Event, {some, Id}).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 749).
-spec event_name(sse_event(), binary()) -> sse_event().
event_name(Event, Name) ->
    erlang:setelement(3, Event, {some, Name}).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 762).
-spec server_sent_events(
    gleam@http@request:request(mist@internal@http:connection()),
    gleam@http@response:response(any()),
    fun(() -> gleam@otp@actor:init_result(HIY, HIZ)),
    fun((HIZ, sse_connection(), HIY) -> gleam@otp@actor:next(HIZ, HIY))
) -> gleam@http@response:response(response_data()).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist.gleam", 807).
...
send_event(Conn, Event) ->
    ...
    Data = begin
        ...
        _pipe@5 = gleam@string_tree:split(_pipe@4, <<"\n"/utf8>>),
        _pipe@6 = gleam@list:map(
            _pipe@5,
            fun(Row) -> gleam@string_tree:prepend(Row, <<"data: "/utf8>>) end
        ),
        gleam@string_tree:join(_pipe@6, <<"\n"/utf8>>)
    end,
    Message = begin
        _pipe@7 = Data,
        _pipe@8 = gleam@string_tree:prepend(_pipe@7, Event_name),
        _pipe@9 = gleam@string_tree:prepend(_pipe@8, Id@1),
    ...
    gleam@result:replace_error(_pipe@12, nil).
