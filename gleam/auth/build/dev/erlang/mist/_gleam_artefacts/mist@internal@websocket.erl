...
-type valid_message(GSC) :: {socket_message, bitstring()} |
    socket_closed_message |
    {user_message, GSC}.

-type websocket_message(GSD) :: {valid, valid_message(GSD)} | invalid.
...
-type handler_message(GSE) :: {internal, gramps@websocket:frame()} | {user, GSE}.

-type websocket_state(GSF) :: {websocket_state,
        bitstring(),
        GSF,
        gleam@option:option(gramps@websocket@compression:compression())}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/websocket.gleam", 56).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/websocket.gleam", 264).
-spec get_messages(
    bitstring(),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/websocket.gleam", 351).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/websocket.gleam", 358).
-spec map_user_selector(gleam@option:option(gleam@erlang@process:selector(GTN))) -> gleam@option:option(gleam@erlang@process:selector(websocket_message(GTN))).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/websocket.gleam", 277).
-spec apply_frames(
    list(gramps@websocket:frame()),
    fun((GTD, websocket_connection(), handler_message(GTE)) -> gleam@otp@actor:next(GTE, GTD)),
    websocket_connection(),
    gleam@otp@actor:next(websocket_message(GTE), GTD),
    fun((GTD) -> nil)
) -> gleam@otp@actor:next(websocket_message(GTE), GTD).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/websocket.gleam", 82).
-spec initialize_connection(
    fun((websocket_connection()) -> {GSO,
        gleam@option:option(gleam@erlang@process:selector(GSP))}),
    fun((GSO) -> nil),
    fun((GSO, websocket_connection(), handler_message(GSP)) -> gleam@otp@actor:next(GSP, GSO)),
    glisten@socket:socket(),
    glisten@transport:transport(),
    list(binary())
) -> {ok, gleam@erlang@process:subject(websocket_message(GSP))} | {error, nil}.
