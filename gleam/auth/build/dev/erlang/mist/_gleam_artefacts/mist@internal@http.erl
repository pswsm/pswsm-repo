...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 76).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 111).
-spec read_data(
    glisten@socket:socket(),
    glisten@transport:transport(),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 238).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 510).
-spec add_date_header(gleam@http@response:response(EVM)) -> gleam@http@response:response(EVM).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 517).
-spec connection_close(gleam@http@response:response(EVP)) -> gleam@http@response:response(EVP).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 521).
-spec keep_alive(gleam@http@response:response(EVS)) -> gleam@http@response:response(EVS).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 525).
-spec maybe_keep_alive(gleam@http@response:response(EVV)) -> gleam@http@response:response(EVV).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 532).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 542).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(EWA)) -> gleam@http@response:response(EWA)).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 562).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 591).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 599).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 82).
-spec parse_headers(
    bitstring(),
    glisten@socket:socket(),
    glisten@transport:transport(),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 620).
-spec crypto_hash(sha_hash(), binary()) -> binary().
crypto_hash(Hash, Data) ->
    crypto:hash(Hash, Data).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 623).
-spec base64_encode(binary()) -> binary().
base64_encode(Data) ->
    base64:encode(Data).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 144).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 251).
                                        ...
                                        fun(_use0@1) ->
                                            ...
                                            gleam@result:then(
                                                ...
                                                fun(Host_header) ->
                                                    ...
                                                    Port@1 = begin
                                                        _pipe@12 = gleam_stdlib:parse_int(
                                                            Port
                                                        ),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 174).
-spec read_chunk(
    glisten@socket:socket(),
    glisten@transport:transport(),
    mist@internal@buffer:buffer(),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 357).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 440).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 447).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/mist/src/mist/internal/http.gleam", 487).
-spec upgrade(
    glisten@socket:socket(),
    glisten@transport:transport(),
    list(binary()),
