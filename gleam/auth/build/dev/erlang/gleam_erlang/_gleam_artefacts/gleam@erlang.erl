...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 17).
-spec format(any()) -> binary().
format(Term) ->
    unicode:characters_to_binary(io_lib:format(<<"~p"/utf8>>, [Term])).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 27).
-spec term_to_binary(any()) -> bitstring().
term_to_binary(A) ->
    erlang:term_to_binary(A).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 80).
-spec get_line(binary()) -> {ok, binary()} | {error, get_line_error()}.
get_line(Prompt) ->
    gleam_erlang_ffi:get_line(Prompt).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 93).
-spec system_time(time_unit()) -> integer().
system_time(A) ->
    os:system_time(A).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 99).
-spec erlang_timestamp() -> {integer(), integer(), integer()}.
erlang_timestamp() ->
    os:timestamp().

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 109).
-spec rescue(fun(() -> HUA)) -> {ok, HUA} | {error, crash()}.
rescue(A) ->
    gleam_erlang_ffi:rescue(A).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 41).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 56).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 124).
-spec start_arguments() -> list(binary()).
start_arguments() ->
    _pipe = init:get_plain_arguments(),
    gleam@list:map(_pipe, fun unicode:characters_to_binary/1).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 147).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 170).
-spec make_reference() -> reference_().
make_reference() ->
    erlang:make_ref().

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 191).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 208).
-spec priv_directory(binary()) -> {ok, binary()} | {error, nil}.
priv_directory(Name) ->
    gleam_erlang_ffi:priv_directory(Name).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 219).
-spec bounded_phash2(any(), integer()) -> integer().
bounded_phash2(Term, Limit) ->
    erlang:phash2(Term, Limit).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_erlang/src/gleam/erlang.gleam", 223).
