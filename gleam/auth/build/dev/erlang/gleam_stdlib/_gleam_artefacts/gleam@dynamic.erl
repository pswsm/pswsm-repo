...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 31).
-spec from(any()) -> dynamic_().
from(A) ->
    gleam_stdlib:identity(A).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 39).
-spec dynamic(dynamic_()) -> {ok, dynamic_()} | {error, list(decode_error())}.
dynamic(Value) ->
    {ok, Value}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 60).
-spec bit_array(dynamic_()) -> {ok, bitstring()} | {error, list(decode_error())}.
bit_array(Data) ->
    gleam_stdlib:decode_bit_array(Data).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 103).
-spec put_expected(decode_error(), binary()) -> decode_error().
put_expected(Error, Expected) ->
    erlang:setelement(2, Error, Expected).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 116).
-spec classify(dynamic_()) -> binary().
classify(Data) ->
    gleam_stdlib:classify_dynamic(Data).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 133).
-spec int(dynamic_()) -> {ok, integer()} | {error, list(decode_error())}.
int(Data) ->
    gleam_stdlib:decode_int(Data).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 156).
-spec float(dynamic_()) -> {ok, float()} | {error, list(decode_error())}.
float(Data) ->
    gleam_stdlib:decode_float(Data).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 179).
-spec bool(dynamic_()) -> {ok, boolean()} | {error, list(decode_error())}.
bool(Data) ->
    gleam_stdlib:decode_bool(Data).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 205).
-spec shallow_list(dynamic_()) -> {ok, list(dynamic_())} |
    {error, list(decode_error())}.
shallow_list(Value) ->
    gleam_stdlib:decode_list(Value).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 348).
-spec optional(fun((dynamic_()) -> {ok, CJE} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(CJE)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 483).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1013).
-spec any(list(fun((dynamic_()) -> {ok, CNE} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        CNE} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1509).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1046).
-spec decode1(
    fun((CNI) -> CNJ),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 555).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 236).
-spec result(
    fun((dynamic_()) -> {ok, CIM} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CIO} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, CIM} | {error, CIO}} |
    {error, list(decode_error())}).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 293).
-spec list(fun((dynamic_()) -> {ok, CIZ} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(CIZ)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 96).
-spec map_errors(
    {ok, CHP} | {error, list(decode_error())},
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 84).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 377).
-spec field(
    any(),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 419).
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, CJS} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(CJS)} |
    {error, list(decode_error())}).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 462).
-spec element(
    integer(),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 545).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 621).
-spec tuple2(
    fun((dynamic_()) -> {ok, CLA} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLC} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {CLA, CLC}} | {error, list(decode_error())}).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 690).
-spec tuple3(
...
) -> fun((dynamic_()) -> {ok, {CLF, CLH, CLJ}} | {error, list(decode_error())}).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 761).
-spec tuple4(
...
) -> fun((dynamic_()) -> {ok, {CLM, CLO, CLQ, CLS}} |
    {error, list(decode_error())}).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 834).
-spec tuple5(
...
) -> fun((dynamic_()) -> {ok, {CLV, CLX, CLZ, CMB, CMD}} |
    {error, list(decode_error())}).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 909).
-spec tuple6(
...
) -> fun((dynamic_()) -> {ok, {CMG, CMI, CMK, CMM, CMO, CMQ}} |
    {error, list(decode_error())}).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 960).
-spec dict(
    fun((dynamic_()) -> {ok, CMT} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CMV} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(CMT, CMV)} |
    {error, list(decode_error())}).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1074).
-spec decode2(
    fun((CNM, CNN) -> CNO),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1106).
-spec decode3(
    fun((CNS, CNT, CNU) -> CNV),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1152).
-spec decode4(
    fun((COA, COB, COC, COD) -> COE),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1208).
-spec decode5(
    fun((COK, COL, COM, CON, COO) -> COP),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1268).
-spec decode6(
    fun((COW, COX, COY, COZ, CPA, CPB) -> CPC),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1333).
-spec decode7(
    fun((CPK, CPL, CPM, CPN, CPO, CPP, CPQ) -> CPR),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1402).
-spec decode8(
    fun((CQA, CQB, CQC, CQD, CQE, CQF, CQG, CQH) -> CQI),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1475).
-spec decode9(
    fun((CQS, CQT, CQU, CQV, CQW, CQX, CQY, CQZ, CRA) -> CRB),
