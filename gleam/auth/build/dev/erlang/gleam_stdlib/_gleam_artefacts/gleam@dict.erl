...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 36).
-spec size(dict(any(), any())) -> integer().
size(Dict) ->
    maps:size(Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 80).
-spec to_list(dict(LB, LC)) -> list({LB, LC}).
to_list(Dict) ->
    maps:to_list(Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 129).
-spec new() -> dict(any(), any()).
new() ->
    maps:new().

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 52).
-spec is_empty(dict(any(), any())) -> boolean().
is_empty(Dict) ->
    Dict =:= maps:new().

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 150).
-spec get(dict(ME, MF), ME) -> {ok, MF} | {error, nil}.
get(From, Get) ->
    gleam_stdlib:map_get(From, Get).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 116).
-spec has_key(dict(LS, any()), LS) -> boolean().
has_key(Dict, Key) ->
    maps:is_key(Key, Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 169).
-spec insert(dict(MK, ML), MK, ML) -> dict(MK, ML).
insert(Dict, Key, Value) ->
    maps:put(Key, Value, Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 92).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 88).
-spec from_list(list({LG, LH})) -> dict(LG, LH).
from_list(List) ->
    maps:from_list(List).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 217).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 224).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 212).
-spec keys(dict(NK, any())) -> list(NK).
keys(Dict) ->
    maps:keys(Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 250).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 245).
-spec values(dict(any(), NZ)) -> list(NZ).
values(Dict) ->
    maps:values(Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 319).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 310).
-spec take(dict(OU, OV), list(OU)) -> dict(OU, OV).
take(Dict, Desired_keys) ->
    maps:with(Desired_keys, Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 357).
-spec insert_pair(dict(PZ, QA), {PZ, QA}) -> dict(PZ, QA).
insert_pair(Dict, Pair) ->
    insert(Dict, erlang:element(1, Pair), erlang:element(2, Pair)).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 361).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 351).
-spec merge(dict(PR, PS), dict(PR, PS)) -> dict(PR, PS).
merge(Dict, New_entries) ->
    maps:merge(Dict, New_entries).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 383).
-spec delete(dict(QM, QN), QM) -> dict(QM, QN).
delete(Dict, Key) ->
    maps:remove(Key, Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 411).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 441).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 486).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 478).
-spec fold(dict(RM, RN), RQ, fun((RQ, RM, RN) -> RQ)) -> RQ.
fold(Dict, Initial, Fun) ->
    fold_loop(maps:to_list(Dict), Initial, Fun).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 188).
-spec map_values(dict(MW, MX), fun((MW, MX) -> NA)) -> dict(MW, NA).
map_values(Dict, Fun) ->
    maps:map(Fun, Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 274).
-spec filter(dict(OI, OJ), fun((OI, OJ) -> boolean())) -> dict(OI, OJ).
filter(Dict, Predicate) ->
    maps:filter(Predicate, Dict).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 519).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_stdlib/src/gleam/dict.gleam", 540).
