...
-type spec(AUM, AUN) :: {spec,
        AUM,
        integer(),
        integer(),
        fun((children(AUM)) -> children(AUN))}.

-opaque children(AUO) :: {ready, starter(AUO)} | {failed, child_start_error()}.

-opaque child_spec(AUP, AUQ, AUR) :: {child_spec,
        fun((AUQ) -> {ok, gleam@erlang@process:subject(AUP)} |
            {error, gleam@otp@actor:start_error()}),
        fun((AUQ, gleam@erlang@process:subject(AUP)) -> AUR)}.
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 87).
-spec start_child(child_spec(any(), AUY, AUZ), AUY) -> {ok, child(AUZ)} |
    {error, child_start_error()}.
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 106).
-spec shutdown_child(
    gleam@erlang@process:pid_(),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 110).
-spec perform_instruction_for_child(
    AVM,
    instruction(),
    child_spec(any(), AVM, AVO),
    child(AVO)
) -> {ok, {child(AVO), instruction()}} | {error, child_start_error()}.
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 132).
-spec add_child_to_starter(
    starter(AVW),
    child_spec(any(), AVW, AVZ),
    child(AVZ)
) -> starter(AVZ).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 164).
-spec start_and_add_child(starter(AWF), child_spec(any(), AWF, AWI)) -> children(AWI).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 178).
-spec add(children(AWN), child_spec(any(), AWN, AWQ)) -> children(AWQ).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 206).
-spec supervisor(
    fun((AWV) -> {ok, gleam@erlang@process:subject(AWW)} |
        {error, gleam@otp@actor:start_error()})
) -> child_spec(AWW, AWV, AWV).
supervisor(Start) ->
    {child_spec, Start, fun(Argument, _) -> Argument end}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 228).
-spec worker(
    fun((AXD) -> {ok, gleam@erlang@process:subject(AXE)} |
        {error, gleam@otp@actor:start_error()})
) -> child_spec(AXE, AXD, AXD).
worker(Start) ->
    {child_spec, Start, fun(Argument, _) -> Argument end}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 241).
-spec returning(
    child_spec(AXL, AXM, any()),
    fun((AXM, gleam@erlang@process:subject(AXL)) -> AXS)
) -> child_spec(AXL, AXM, AXS).
returning(Child, Updater) ->
    {child_spec, erlang:element(2, Child), Updater}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 248).
-spec init(spec(any(), AXX)) -> gleam@otp@actor:init_result(state(AXX), message()).
init(Spec) ->
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 305).
-spec handle_exit(gleam@erlang@process:pid_(), state(AYD)) -> gleam@otp@actor:next(message(), state(AYD)).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 345).
-spec loop(message(), state(AYI)) -> gleam@otp@actor:next(message(), state(AYI)).
loop(Message, State) ->
    case Message of
        {exit, Exit_message} ->
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 377).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 408).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 438).
-spec application_stopped() -> application_stop().
application_stopped() ->
    gleam_otp_external:application_stopped().

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 457).
