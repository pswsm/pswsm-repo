...
-type pool(DFH, DFI) :: {pool,
        fun((glisten@internal@handler:loop_message(DFH), DFI, glisten@internal@handler:connection(DFH)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(DFH), DFI)),
        integer(),
        fun((glisten@internal@handler:connection(DFH)) -> {DFI,
            gleam@option:option(gleam@erlang@process:selector(DFH))}),
        gleam@option:option(fun((DFI) -> nil)),
        glisten@transport:transport()}.

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/internal/acceptor.gleam", 38).
-spec start(
    pool(any(), any()),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/internal/acceptor.gleam", 123).
-spec start_pool(
    pool(any(), any()),
    glisten@transport:transport(),
    integer(),
