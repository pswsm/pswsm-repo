...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/internal/telemetry.gleam", 42).
-spec log(
    list(event()),
...
log(Path, Measurements, _, _) ->
    Duration_string = begin
        ...
        _pipe@1 = gleam@result:then(
            _pipe,
            fun(Val) ->
                gleam@result:replace_error(gleam@dynamic:int(Val), nil)
            end
        ),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/internal/telemetry.gleam", 60).
-spec span(
    list(event()),
    gleam@dict:dict(binary(), gleam@dynamic:dynamic_()),
    fun(() -> EBC)
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/internal/telemetry.gleam", 77).
-spec attach_many(
    binary(),
    list(list(event())),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/internal/telemetry.gleam", 106).
-spec attach(
    binary(),
    list(event()),
    fun((list(event()), gleam@dict:dict(gleam@erlang@atom:atom_(), gleam@dynamic:dynamic_()), gleam@dict:dict(binary(), gleam@dynamic:dynamic_()), list(any())) -> nil),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/internal/telemetry.gleam", 124).
