...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 17).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 28).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 39).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 50).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 60).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 67).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 79).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 90).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 101).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 108).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 118).
-spec set_opts(
    transport(),
    glisten@socket:socket(),
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 129).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 139).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 149).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 173).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 177).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 197).
-spec socket_info(glisten@socket:socket()) -> gleam@dict:dict(gleam@erlang@atom:atom_(), gleam@dynamic:dynamic_()).
socket_info(Socket) ->
    socket:info(Socket).

-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 199).
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 210).
...
set_buffer_size(Transport, Socket) ->
    ...
    _pipe@1 = gleam@result:then(_pipe, fun(P) -> case P of
                [{_, Value}] ->
                    gleam@result:replace_error(gleam@dynamic:int(Value), nil);
...
-file("/home/pswsm/code/pswsm-repo/gleam/auth/build/packages/glisten/src/glisten/transport.gleam", 223).
