...
-spec add_date_header(gleam@http@response:response(MSQ)) -> gleam@http@response:response(MSQ).
...
-spec connection_close(gleam@http@response:response(MST)) -> gleam@http@response:response(MST).
...
-spec keep_alive(gleam@http@response:response(MSW)) -> gleam@http@response:response(MSW).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
-spec maybe_keep_alive(gleam@http@response:response(MSZ)) -> gleam@http@response:response(MSZ).
...
-file("/home/alex/gleams/mist/src/mist/internal/http.gleam", 542).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(MTE)) -> gleam@http@response:response(MTE)).
...
-file("/home/alex/gleams/mist/src/mist/internal/http.gleam", 562).
...
-file("/home/alex/gleams/mist/src/mist/internal/http.gleam", 591).
...
-file("/home/alex/gleams/mist/src/mist/internal/http.gleam", 599).
...
-file("/home/alex/gleams/mist/src/mist/internal/http.gleam", 620).
-spec crypto_hash(sha_hash(), binary()) -> binary().
crypto_hash(Hash, Data) ->
    crypto:hash(Hash, Data).

-file("/home/alex/gleams/mist/src/mist/internal/http.gleam", 623).
