...
-file("/home/alex/gleams/mist/src/mist/internal/http/handler.gleam", 67).
-spec log_and_error(
    gleam@erlang:crash(),
...
-file("/home/alex/gleams/mist/src/mist/internal/http/handler.gleam", 101).
...
-file("/home/alex/gleams/mist/src/mist/internal/http/handler.gleam", 159).
...
-file("/home/alex/gleams/mist/src/mist/internal/http/handler.gleam", 219).
...
-file("/home/alex/gleams/mist/src/mist/internal/http/handler.gleam", 246).
-spec int_to_hex(integer()) -> binary().
int_to_hex(Int) ->
    erlang:integer_to_list(Int, 16).

-file("/home/alex/gleams/mist/src/mist/internal/http/handler.gleam", 121).
